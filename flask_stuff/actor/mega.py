...
from modules import get_names, get_ans, get_id
...
class NameForm(FlaskForm):
    name = StringField('How can we help?', validators=[DataRequired(), Length(10, 40)])
